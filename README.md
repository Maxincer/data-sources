...
节假日调整日的涨跌停价和保证金率，新表使用调整前数值（与原表一致），不计为差异。

| 交易所 | 受影响字段 | 差异量（20260429 示例） |
|:-----:|:---------|:---------------------:|
| DCE | maxup/maxdown | 225 条（修正后清零） |
| DCE | long/short_margin | 123 条（修正后清零） |
| CZC | long/short_margin | 149 条（修正后清零） |
| GFE | long/short_margin | 47 条（修正后清零） |
| INE | long/short_margin | 3 条（修正后清零） |
| SHF | long/short_margin | 25 条（修正后清零） |
